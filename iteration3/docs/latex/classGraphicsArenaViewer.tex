...
\item 
\hyperlink{classGraphicsArenaViewer_adab00db9d4afcbf3d4fb27bfe35eb32d}{Graphics\+Arena\+Viewer} (struct \hyperlink{structarena__params}{arena\+\_\+params} $\ast$params, \hyperlink{classArena}{Arena} $\ast$arena, \hyperlink{classController}{Controller} $\ast$controller)
...
\begin{DoxyCompactList}\small\item\em Handle the user pressing the food button on the G\+UI. \end{DoxyCompactList}\item 
...
void \hyperlink{classGraphicsArenaViewer_a0c8068efadaa2933555071cea796543a}{Update\+Arena} (\hyperlink{classArena}{Arena} $\ast$arena)
\begin{DoxyCompactList}\small\item\em Update graphics\+\_\+arena\+\_\+viewer after user selection. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\index{Graphics\+Arena\+Viewer@{Graphics\+Arena\+Viewer}!Graphics\+Arena\+Viewer@{Graphics\+Arena\+Viewer}}
\subsubsection[{\texorpdfstring{Graphics\+Arena\+Viewer(struct arena\+\_\+params $\ast$params, Arena $\ast$arena, Controller $\ast$controller)}{GraphicsArenaViewer(struct arena_params *params, Arena *arena, Controller *controller)}}]{\setlength{\rightskip}{0pt plus 5cm}Graphics\+Arena\+Viewer\+::\+Graphics\+Arena\+Viewer (
\begin{DoxyParamCaption}
\item[{struct {\bf arena\+\_\+params} $\ast$}]{params, }
\item[{{\bf Arena} $\ast$}]{arena, }
\item[{{\bf Controller} $\ast$}]{controller}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [explicit]}}\hypertarget{classGraphicsArenaViewer_adab00db9d4afcbf3d4fb27bfe35eb32d}{}\label{classGraphicsArenaViewer_adab00db9d4afcbf3d4fb27bfe35eb32d}
...
\hline
\end{DoxyParams}
\index{Graphics\+Arena\+Viewer@{Graphics\+Arena\+Viewer}!On\+Food\+Btn\+Pressed@{On\+Food\+Btn\+Pressed}}
...
Handle the user pressing the food button on the G\+UI. 

This will turn on/off food in the arena \index{Graphics\+Arena\+Viewer@{Graphics\+Arena\+Viewer}!On\+Key\+Down@{On\+Key\+Down}}
...
This will restart the game the the new setting such as new postion for all entities and reset lives. \index{Graphics\+Arena\+Viewer@{Graphics\+Arena\+Viewer}!On\+Playing\+Btn\+Pressed@{On\+Playing\+Btn\+Pressed}}
...
\hline
\end{DoxyParams}
\index{Graphics\+Arena\+Viewer@{Graphics\+Arena\+Viewer}!Update\+Arena@{Update\+Arena}}
\index{Update\+Arena@{Update\+Arena}!Graphics\+Arena\+Viewer@{Graphics\+Arena\+Viewer}}
\subsubsection[{\texorpdfstring{Update\+Arena(\+Arena $\ast$arena)}{UpdateArena(Arena *arena)}}]{\setlength{\rightskip}{0pt plus 5cm}void Graphics\+Arena\+Viewer\+::\+Update\+Arena (
\begin{DoxyParamCaption}
\item[{{\bf Arena} $\ast$}]{arena}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{classGraphicsArenaViewer_a0c8068efadaa2933555071cea796543a}{}\label{classGraphicsArenaViewer_a0c8068efadaa2933555071cea796543a}


Update graphics\+\_\+arena\+\_\+viewer after user selection. 


\begin{DoxyParams}{Parameters}
{\em arena} & new arena instances \\
\hline
\end{DoxyParams}
